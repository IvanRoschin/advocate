...
const mockData: ClientDashboardData = {
  client: {
    ...
    notes: 'Основний контакт для комунікації у справі.',
  },
  access: {
    accessRole: 'owner',
    isActive: true,
  ...
  cases: [
    {
      ...
      description: 'Перевірка умов договору та підготовка правової позиції.',
      status: 'in_progress',
    ...
    },
    {
      ...
      description: 'Комунікація з іншою стороною та підготовка претензії.',
      status: 'awaiting_client',
      currentStage: 'Очікуємо документи від клієнта',
      updatedAt: '2026-04-04T09:10:00.000Z',
    },
    {
      id: 'case_3',
      title: 'Супровід судової справи',
      description: 'Підготовка документів та представництво інтересів.',
      status: 'completed',
      currentStage: 'Справу завершено',
...
const accessRoleMeta: Record<ClientAccessRole, string> = {
...
const getCasesSummary = (cases: ClientDashboardCase[]) => {
...
const getProfileCompleteness = (data: ClientDashboardData['client']) => {
  const fields = [
    data.fullName,
    data.email,
    data.phone,
