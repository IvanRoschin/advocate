...
const Services = () => {
	return (
		<section className="absolute top-full left-0 w-full -translate-y-1/5 sm:-translate-y-1/4 md:-translate-y-1/2 z-20">
			<div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:py-10">
				{data.map((service, i) => (
					<ServiceCard
						key={i}
						icon={service.icon}
