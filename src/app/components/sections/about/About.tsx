    ...
    >
      <div className="font-eukraine container">
        <header className="mb-10 flex flex-col items-center text-center sm:mb-14">
          ...
          <h2 className="text-about-title font-eukrainehead mt-2 text-2xl font-bold sm:text-3xl md:text-4xl">
        ...
        <div className="flex flex-col items-center justify-center gap-8 md:flex-row md:gap-0 lg:mt-30">
          ...
          <div className="bg-about-card text-app w-full max-w-90 space-y-4 p-6 text-sm sm:p-8 sm:text-base md:max-w-[50%] md:p-14">
            <h3 className="text-about-card-title font-eukrainehead text-lg font-semibold sm:text-xl">
            ...
            {phones.length > 0 && (
              <div
                ...
                itemType="https://schema.org/Person"
              >
                <p className="text-about-card-title font-medium">Телефон:</p>
